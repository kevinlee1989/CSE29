...
String join(String strs[], uint64_t length, String delimiter){
    // Problem with this signatrue - don't know how long strs is! -> fix it by adding one more parameter length
